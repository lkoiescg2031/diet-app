...
skills/
  diet-app--agent-or-skill-change/SKILL.md
  diet-app--feature-design/SKILL.md
  diet-app--local-storage-change/SKILL.md
  diet-app--ui-change/SKILL.md
  diet-app--test-and-verify/SKILL.md
...
- `diet-app--agent-or-skill-change`: AI 하네스 자체를 변경하는 절차
- `diet-app--feature-design`: 제품 아이디어를 프로젝트 spec으로 바꾸는 절차
- `diet-app--local-storage-change`: 브라우저 저장 데이터 변경을 안전하게 처리하는 절차
- `diet-app--ui-change`: 화면이나 공유 UI 동작을 변경하는 절차
- `diet-app--test-and-verify`: 완료 주장 전에 검증을 선택하고 실행하는 절차
